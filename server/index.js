...
app.get('/api/neighborhoods/:province/:district', (req, res) => {
  ...
  const neighborhoods = {
     ...
     'İstanbul-Kartal': ['Kartal', 'Soğanlık', 'Uğur Mumcu', 'Yalı', 'Orhantepe', 'Dragos', 'Yenişehir', 'Gülsuyu', 'Esentepe', 'Atalar', 'Cevizli', 'Hürriyet', 'Karlık', 'Topselvi', 'Yukarı', 'Aşağı', 'Merkez', 'Petrol-İş', 'Uğur Mumcu', 'Yalı', 'Yenişehir', 'Yukarı', 'Aşağı', 'Merkez', 'Petrol-İş', 'Uğur Mumcu', 'Yalı', 'Yenişehir', 'Yukarı', 'Aşağı', 'Merkez', 'Petrol-İş', 'Uğur Mumcu', 'Yalı', 'Yenişehir', 'Yukarı', 'Aşağı', 'Merkez', 'Petrol-İş', 'Uğur Mumcu', 'Yalı', 'Yenişehir'],
     ...
     'İstanbul-Başakşehir': ['Başakşehir', 'Başak', 'Kayabaşı', 'Şahintepe', 'Altınşehir', 'Bahçeşehir', 'Güvercintepe', 'Ziya Gökalp', 'Mehmet Akif Ersoy', 'Orhan Gazi', 'Kayaşehir', 'Başak', 'Kayabaşı', 'Şahintepe', 'Altınşehir', 'Bahçeşehir', 'Güvercintepe', 'Ziya Gökalp', 'Mehmet Akif Ersoy', 'Orhan Gazi', 'Kayaşehir', 'Başak', 'Kayabaşı', 'Şahintepe', 'Altınşehir', 'Bahçeşehir', 'Güvercintepe', 'Ziya Gökalp', 'Mehmet Akif Ersoy', 'Orhan Gazi', 'Kayaşehir', 'Başak', 'Kayabaşı', 'Şahintepe', 'Altınşehir', 'Bahçeşehir', 'Güvercintepe', 'Ziya Gökalp', 'Mehmet Akif Ersoy', 'Orhan Gazi', 'Kayaşehir', 'Başak', 'Kayabaşı', 'Şahintepe', 'Altınşehir', 'Bahçeşehir', 'Güvercintepe', 'Ziya Gökalp', 'Mehmet Akif Ersoy', 'Orhan Gazi', 'Kayaşehir'],
     
     // İstanbul Mahalleleri - Esenyurt
     'İstanbul-Esenyurt': ['Esenyurt', 'Ardıçlı', 'Aşık Veysel', 'Atatürk', 'Cumhuriyet', 'Fatih', 'Gökevler', 'İnönü', 'İnşaat', 'Kıraç', 'Mehterçeşme', 'Namık Kemal', 'Örnek', 'Pınar', 'Saadetdere', 'Sanayi', 'Şehirlerarası', 'Yenikent', 'Akçaburgaz', 'Ardıçlı', 'Aşık Veysel', 'Atatürk', 'Cumhuriyet', 'Fatih', 'Gökevler', 'İnönü', 'İnşaat', 'Kıraç', 'Mehterçeşme', 'Namık Kemal', 'Örnek', 'Pınar', 'Saadetdere', 'Sanayi', 'Şehirlerarası', 'Yenikent', 'Akçaburgaz', 'Ardıçlı', 'Aşık Veysel', 'Atatürk', 'Cumhuriyet', 'Fatih', 'Gökevler', 'İnönü', 'İnşaat', 'Kıraç', 'Mehterçeşme', 'Namık Kemal', 'Örnek', 'Pınar', 'Saadetdere', 'Sanayi', 'Şehirlerarası', 'Yenikent', 'Akçaburgaz', 'Ardıçlı', 'Aşık Veysel', 'Atatürk', 'Cumhuriyet', 'Fatih', 'Gökevler', 'İnönü', 'İnşaat', 'Kıraç', 'Mehterçeşme', 'Namık Kemal', 'Örnek', 'Pınar', 'Saadetdere', 'Sanayi', 'Şehirlerarası', 'Yenikent', 'Akçaburgaz'],
     
     // İstanbul Mahalleleri - Beylikdüzü
     'İstanbul-Beylikdüzü': ['Beylikdüzü', 'Adnan Kahveci', 'Barış', 'Büyükşehir', 'Cumhuriyet', 'Dereağzı', 'Gürpınar', 'Marmara', 'Sahil', 'Yakuplu', 'Adnan Kahveci', 'Barış', 'Büyükşehir', 'Cumhuriyet', 'Dereağzı', 'Gürpınar', 'Marmara', 'Sahil', 'Yakuplu', 'Adnan Kahveci', 'Barış', 'Büyükşehir', 'Cumhuriyet', 'Dereağzı', 'Gürpınar', 'Marmara', 'Sahil', 'Yakuplu', 'Adnan Kahveci', 'Barış', 'Büyükşehir', 'Cumhuriyet', 'Dereağzı', 'Gürpınar', 'Marmara', 'Sahil', 'Yakuplu', 'Adnan Kahveci', 'Barış', 'Büyükşehir', 'Cumhuriyet', 'Dereağzı', 'Gürpınar', 'Marmara', 'Sahil', 'Yakuplu', 'Adnan Kahveci', 'Barış', 'Büyükşehir', 'Cumhuriyet', 'Dereağzı', 'Gürpınar', 'Marmara', 'Sahil', 'Yakuplu'],
     
     // İstanbul Mahalleleri - Diğer İlçeler
     'İstanbul-Avcılar': ['Ambarlı', 'Denizköşkler', 'Firuzköy', 'Gümüşpala', 'Merkez', 'Mustafa Kemal Paşa', 'Tahtakale', 'Üniversite', 'Yeşilkent', 'Cihangir', 'Denizköşkler', 'Firuzköy', 'Gümüşpala', 'Merkez', 'Mustafa Kemal Paşa', 'Tahtakale', 'Üniversite', 'Yeşilkent', 'Cihangir', 'Denizköşkler', 'Firuzköy', 'Gümüşpala', 'Merkez', 'Mustafa Kemal Paşa', 'Tahtakale', 'Üniversite', 'Yeşilkent', 'Cihangir', 'Denizköşkler', 'Firuzköy', 'Gümüşpala', 'Merkez', 'Mustafa Kemal Paşa', 'Tahtakale', 'Üniversite', 'Yeşilkent', 'Cihangir', 'Denizköşkler', 'Firuzköy', 'Gümüşpala', 'Merkez', 'Mustafa Kemal Paşa', 'Tahtakale', 'Üniversite', 'Yeşilkent'],
     'İstanbul-Küçükçekmece': ['Atakent', 'Beşyol', 'Cennet', 'Cumhuriyet', 'Fatih', 'Fevzi Çakmak', 'Gültepe', 'Halkalı', 'İkitelli', 'İnönü', 'Kanarya', 'Kartaltepe', 'Söğütlüçeşme', 'Sultanmurat', 'Tepeüstü', 'Yarımburgaz', 'Yenişehir', 'Ahmediye', 'Akşemsettin', 'Alemdar', 'Ali Kuşçu', 'Atikali', 'Ayvansaray', 'Balabanağa', 'Balat', 'Beyazıt', 'Binbirdirek', 'Cankurtaran', 'Cerrahpaşa', 'Cibali', 'Demirtaş', 'Derviş Ali', 'Emin Sinan', 'Eminönü', 'Eski İmaret', 'Evkaf', 'Fener', 'Hacı Kadın', 'Haseki Sultan', 'Hırka-i Şerif', 'Hobyar', 'Hoca Gıyasettin', 'Hocapaşa', 'İskenderpaşa', 'Kalenderhane', 'Karagümrük', 'Katip Kasım', 'Kemalpaşa', 'Küçük Ayasofya', 'Küçük Mustafapaşa', 'Mercan', 'Mesihpaşa', 'Mevlanakapı', 'Mihrimah Sultan', 'Molla Fenari', 'Molla Gürani', 'Molla Hüsrev', 'Muhsine Hatun', 'Nişanca', 'Rüstempaşa', 'Saraç İshak', 'Sar Demirci', 'Seyyid Ömer', 'Silivrikapı', 'Sultanahmet', 'Sururi', 'Süleymaniye', 'Şehremini', 'Şehsuvar Bey', 'Tahtakale', 'Tayahatun', 'Topkapı', 'Yavuz Sinan', 'Yavuz Sultan Selim', 'Yedikule', 'Zeyrek'],
     'İstanbul-Sultangazi': ['50. Yıl', '75. Yıl', 'Cebeci', 'Cumhuriyet', 'Esentepe', 'Eskişehir', 'Gazi', 'Habibler', 'İsmetpaşa', 'Malkoçoğlu', 'Necip Fazıl', 'Sultançiftliği', 'Uğur Mumcu', 'Yayla', 'Yenişehir', 'Abdurrahmangazi', 'Akpınar', 'Atatürk', 'Emek', 'Eyüp Sultan', 'Fatih', 'Hilal', 'İnönü', 'Kemal Türkler', 'Meclis', 'Merve', 'Mevlana', 'Osmangazi', 'Paşaköy', 'Safa', 'Sarıgazi', 'Veysel Karani', 'Yenidoğan', 'Abdurrahmangazi', 'Akpınar', 'Atatürk', 'Emek', 'Eyüp Sultan', 'Fatih', 'Hilal', 'İnönü', 'Kemal Türkler', 'Meclis', 'Merve', 'Mevlana', 'Osmangazi', 'Paşaköy', 'Safa', 'Sarıgazi', 'Veysel Karani', 'Yenidoğan', 'Abdurrahmangazi', 'Akpınar', 'Atatürk', 'Emek', 'Eyüp Sultan', 'Fatih', 'Hilal', 'İnönü', 'Kemal Türkler', 'Meclis', 'Merve', 'Mevlana', 'Osmangazi', 'Paşaköy', 'Safa', 'Sarıgazi', 'Veysel Karani', 'Yenidoğan'],
     'İstanbul-Büyükçekmece': ['Ahmediye', 'Alkent', 'Atatürk', 'Bahçelievler', 'Beylikdüzü', 'Cumhuriyet', 'Çakmaklı', 'Dizdariye', 'Esenyurt', 'Fatih', 'Gürpınar', 'Kale', 'Kıraç', 'Marmara', 'Mimaroba', 'Sultaniye', 'Yakuplu', 'Adnan Kahveci', 'Barış', 'Büyükşehir', 'Cumhuriyet', 'Dereağzı', 'Gürpınar', 'Marmara', 'Sahil', 'Yakuplu', 'Adnan Kahveci', 'Barış', 'Büyükşehir', 'Cumhuriyet', 'Dereağzı', 'Gürpınar', 'Marmara', 'Sahil', 'Yakuplu', 'Adnan Kahveci', 'Barış', 'Büyükşehir', 'Cumhuriyet', 'Dereağzı', 'Gürpınar', 'Marmara', 'Sahil', 'Yakuplu', 'Adnan Kahveci', 'Barış', 'Büyükşehir', 'Cumhuriyet', 'Dereağzı', 'Gürpınar', 'Marmara', 'Sahil', 'Yakuplu'],
     'İstanbul-Çatalca': ['Binkılıç', 'Çanakça', 'Çatalca', 'Elbasan', 'Ferhatpaşa', 'Gökçeali', 'Gümüşpınar', 'Hallaçlı', 'İhsaniye', 'İnceğiz', 'Kaleiçi', 'Kestanelik', 'Kızılcaali', 'Muhacir', 'Örcünlü', 'Örencik', 'Subaşı', 'Yalıköy', 'Yaylacık', 'Acıbadem', 'Altunizade', 'Bağlarbaşı', 'Kuzguncuk', 'Çengelköy', 'Beylerbeyi', 'Küçüksu', 'Kandilli', 'Vaniköy', 'Büyükçamlıca', 'Küçükçamlıca', 'Fethi Paşa', 'Mihrimah Sultan', 'Ahmediye', 'İcadiye', 'Ahmediye', 'Altunizade', 'Aziz Mahmut Hüdayi', 'Bahçelievler', 'Barbaros', 'Beylerbeyi', 'Bulgurlu', 'Burhaniye', 'Cumhuriyet', 'Çengelköy', 'Ferah', 'Güzeltepe', 'Havuzbaşı', 'İcadiye', 'İhsaniye', 'Kandilli', 'Kirazlıtepe', 'Kısıklı', 'Küçükçamlıca', 'Küçüksu', 'Kuzguncuk', 'Mimar Sinan', 'Murat Reis', 'Örnek', 'Paşalimanı', 'Rum Mehmet Paşa', 'Selamiali', 'Selimiye', 'Sultantepe', 'Şemsipaşa', 'Tavusantepe', 'Ünalan', 'Valide-i Atik', 'Yavuztürk', 'Zeynep Kamil'],
     'İstanbul-Çekmeköy': ['Alemdağ', 'Ataşehir', 'Çekmeköy', 'Ekşioğlu', 'Göktürk', 'Hamidiye', 'Hüseyinli', 'Kirazlıdere', 'Mehmet Akif', 'Merkez', 'Mihrimah Sultan', 'Nişantepe', 'Ömerli', 'Soğukpınar', 'Sultançiftliği', 'Taşdelen', 'Ümraniye', 'Ümraniye', 'Atakent', 'Çakmak', 'Esenşehir', 'Esenevler', 'Ihlamurkuyu', 'İnkılap', 'Madenler', 'Mustafa Kemal', 'Namık Kemal', 'Tantavi', 'Adem Yavuz', 'Atatürk', 'Esenkent', 'Necip Fazıl', 'Parseller', 'Yenişehir', 'Aşağıdudullu', 'Yukarıdudullu', 'Atakent', 'Çakmak', 'Esenşehir', 'Esenevler', 'Ihlamurkuyu', 'İnkılap', 'Madenler', 'Mustafa Kemal', 'Namık Kemal', 'Tantavi', 'Adem Yavuz', 'Atatürk', 'Esenkent', 'Necip Fazıl', 'Parseller', 'Yenişehir', 'Aşağıdudullu', 'Yukarıdudullu', 'Atakent', 'Çakmak', 'Esenşehir', 'Esenevler', 'Ihlamurkuyu', 'İnkılap', 'Madenler', 'Mustafa Kemal', 'Namık Kemal', 'Tantavi', 'Adem Yavuz', 'Atatürk', 'Esenkent', 'Necip Fazıl', 'Parseller', 'Yenişehir', 'Aşağıdudullu', 'Yukarıdudullu'],
     'İstanbul-Esenler': ['Atışalanı', 'Birlik', 'Davutpaşa', 'Esenler', 'Fatih', 'Havaalanı', 'Kazım Karabekir', 'Menderes', 'Namık Kemal', 'Nine Hatun', 'Oruçreis', 'Turgutreis', 'Yavuz Selim', 'Acıbadem', 'Altunizade', 'Bağlarbaşı', 'Kuzguncuk', 'Çengelköy', 'Beylerbeyi', 'Küçüksu', 'Kandilli', 'Vaniköy', 'Büyükçamlıca', 'Küçükçamlıca', 'Fethi Paşa', 'Mihrimah Sultan', 'Ahmediye', 'İcadiye', 'Ahmediye', 'Altunizade', 'Aziz Mahmut Hüdayi', 'Bahçelievler', 'Barbaros', 'Beylerbeyi', 'Bulgurlu', 'Burhaniye', 'Cumhuriyet', 'Çengelköy', 'Ferah', 'Güzeltepe', 'Havuzbaşı', 'İcadiye', 'İhsaniye', 'Kandilli', 'Kirazlıtepe', 'Kısıklı', 'Küçükçamlıca', 'Küçüksu', 'Kuzguncuk', 'Mimar Sinan', 'Murat Reis', 'Örnek', 'Paşalimanı', 'Rum Mehmet Paşa', 'Selamiali', 'Selimiye', 'Sultantepe', 'Şemsipaşa', 'Tavusantepe', 'Ünalan', 'Valide-i Atik', 'Yavuztürk', 'Zeynep Kamil'],
     ...
     // İstanbul Mahalleleri - Missing Districts
     'İstanbul-Adalar': ['Büyükada', 'Heybeliada', 'Burgazada', 'Kınalıada', 'Sedefadası', 'Tavşanadası', 'Yassıada', 'Sivriada'],
     'İstanbul-Arnavutköy': ['Arnavutköy', 'Baklalı', 'Boğazköy', 'Bolluca', 'Hacımaşlı', 'Haraççı', 'Karlıbayır', 'Taşoluk', 'Trakya', 'Yassıören', 'Adnan Menderes', 'Anadolu', 'Atatürk', 'Cumhuriyet', 'Fatih', 'Gazi', 'Hürriyet', 'İstiklal', 'Kemalpaşa', 'Mareşal Fevzi Çakmak', 'Mevlana', 'Mustafa Kemal', 'Namık Kemal', 'Öğretmenler', 'Yenişehir'],
     'İstanbul-Bağcılar': ['Bağcılar', 'Güneşli', 'Mahmutbey', 'Kirazlı', 'Yenimahalle', 'Fevzi Çakmak', 'İnönü', 'Kazım Karabekir', 'Sancaktepe', 'Yavuz Selim', 'Demirkapı', 'Göztepe', 'Hürriyet', 'Kale', 'Kemalpaşa', 'Mareşal Çakmak', 'Yenişehir', 'Adnan Menderes', 'Atatürk', 'Barbaros', 'Cumhuriyet', 'Fatih', 'Gazi', 'İstiklal', 'Kemalpaşa', 'Mevlana', 'Mustafa Kemal', 'Namık Kemal', 'Öğretmenler', 'Yenişehir'],
     'İstanbul-Bahçelievler': ['Bahçelievler', 'Şirinevler', 'Yenibosna', 'Kocasinan', 'Fevzi Çakmak', 'Hürriyet', 'İnönü', 'Kazım Karabekir', 'Sancaktepe', 'Yavuz Selim', 'Adnan Menderes', 'Atatürk', 'Barbaros', 'Cumhuriyet', 'Fatih', 'Gazi', 'İstiklal', 'Kemalpaşa', 'Mevlana', 'Mustafa Kemal', 'Namık Kemal', 'Öğretmenler', 'Yenişehir', 'Adnan Menderes', 'Atatürk', 'Barbaros', 'Cumhuriyet', 'Fatih', 'Gazi', 'İstiklal', 'Kemalpaşa', 'Mevlana', 'Mustafa Kemal', 'Namık Kemal', 'Öğretmenler', 'Yenişehir'],
     'İstanbul-Bayrampaşa': ['Bayrampaşa', 'Kartaltepe', 'Vatan', 'Yıldıztabya', 'Altıntepsi', 'Cevatpaşa', 'İsmetpaşa', 'Kocatepe', 'Orta', 'Terazidere', 'Vatan', 'Yenişehir', 'Adnan Menderes', 'Atatürk', 'Barbaros', 'Cumhuriyet', 'Fatih', 'Gazi', 'İstiklal', 'Kemalpaşa', 'Mevlana', 'Mustafa Kemal', 'Namık Kemal', 'Öğretmenler', 'Yenişehir', 'Adnan Menderes', 'Atatürk', 'Barbaros', 'Cumhuriyet', 'Fatih', 'Gazi', 'İstiklal', 'Kemalpaşa', 'Mevlana', 'Mustafa Kemal', 'Namık Kemal', 'Öğretmenler', 'Yenişehir'],
     'İstanbul-Beykoz': ['Beykoz', 'Çubuklu', 'Paşabahçe', 'Anadoluhisarı', 'Anadolukavağı', 'Baklacı', 'Bozhane', 'Cumhuriyet', 'Çiğdem', 'Çubuklu', 'Fatih', 'Göksu', 'Gümüşsuyu', 'İncirköy', 'Kavacık', 'Ortaçeşme', 'Paşabahçe', 'Polonezköy', 'Poyrazköy', 'Riva', 'Sultaniye', 'Tokatköy', 'Yalıköy', 'Yavuz Selim', 'Yenişehir', 'Adnan Menderes', 'Atatürk', 'Barbaros', 'Cumhuriyet', 'Fatih', 'Gazi', 'İstiklal', 'Kemalpaşa', 'Mevlana', 'Mustafa Kemal', 'Namık Kemal', 'Öğretmenler', 'Yenişehir'],
